...
export default function ShipmentTrackingDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] text-[#0B1D3A] selection:bg-[#C9A84C]/20 pt-10 pb-20">
      ...
      <div className="relative bg-[#0B1D3A]  py-20 px-6 ">
                ...
                <section className="space-y-5">
                  ...
                  <div className="rounded-[3rem] flex justify-center  border border-slate-100 bg-white shadow-2xl p-4">
                    <img
                      ...
                      alt="Consignment"
                      className=" h-64 md:h-[600px]  rounded-[2rem]"
                    />
                  </div>
                </section>
              )}
            ...
            <div className="relative pl-10 space-y-12 before:absolute before:left-[19px] before:top-2 before:bottom-2 before:w-px before:bg-slate-100">
              {shipmentData.shippingStages.map((stage, idx) => (
                <div key={idx} className="relative">
                  <div className=" w-5 h-5 rounded-full border-4 border-white bg-[#C9A84C] shadow-lg" />
